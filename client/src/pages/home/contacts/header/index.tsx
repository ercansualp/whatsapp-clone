    ...
    return (
        <header className="py-2.5 px-4 flex justify-between bg-[#202c33] h-[59px]">
            ...
            <div className="flex gap-2.5 text-[#aebac1]">
                ...
                <button className="w-10 h-10 flex justify-center items-center" onClick={() => setValue(3)}>
                    <svg viewBox="0 0 24 24" height={24} width={24}>
                        <path
                ...
                <Popover className="relative">
                    <Popover.Button onClick={() => setShowMenu(true)} className={classNames("w-10 transition-all rounded-full h-10 flex justify-center items-center outline-none", {
                        "bg-[#ffffff18]": showMenu,
                        "bg-[#202c33]": !showMenu
                    })}>
                        <svg viewBox="0 0 24 24" height={24} width={24}><title>menu</title>
                    ...
                    <Transition
                        ...
                        className="absolute top-11 right-1 bg-[#233138] py-[9px] flex flex-col max-w-[340px] min-w-[243.031px] z-50"
                        ref={ref}
                    >
                        <Popover.Panel>
                            <ul className="text-[14.5px] font-normal leading-[14.5px] text-[#d1d7db] block">
                                <li>
                                    <div className="pl-6 pr-[58px] flex items-center cursor-pointer hover:bg-[#182229] transition-all h-10">Yeni grup</div>
                                </li>
                                <li>
                                    <div className="pl-6 pr-[58px] flex items-center cursor-pointer hover:bg-[#182229] transition-all h-10">Yeni topluluk</div>
                                </li>
                                <li>
                                    <div className="pl-6 pr-[58px] flex items-center cursor-pointer hover:bg-[#182229] transition-all h-10">Arşivlenmiş</div>
                                </li>
                                <li>
                                    <div className="pl-6 pr-[58px] flex items-center cursor-pointer hover:bg-[#182229] transition-all h-10">Yıldızlı mesajlar</div>
                                </li>
                                <li>
                                    <div className="pl-6 pr-[58px] flex items-center cursor-pointer hover:bg-[#182229] transition-all h-10">Sohbetleri seç</div>
                                </li>
                                <li>
                                ...
                                <li>
                                    <div className="px-6 flex items-center cursor-pointer hover:bg-[#182229] transition-all h-10">
                                        Windows için WhatsApp'ı indir
                                    </div>
                                </li>
                            </ul>
                        </Popover.Panel>
