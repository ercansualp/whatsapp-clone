export default function Call() {
    return (
        <div className="px-2.5 pt-[5px] pb-[3px] border border-[#8696a026] rounded-[100px] flex items-center justify-center">
            <button className="flex items-center gap-x-1.5 text-[#54656fd9]">
                ...
                <svg viewBox="0 0 17 13" height="10" preserveAspectRatio="xMidYMid meet" className="" version="1.1" x="0px" y="0px" enableBackground="new 0 0 17 13"><title>chevron-down-alt</title><path fill="currentColor" d="M3.202,2.5l5.2,5.2l5.2-5.2l1.5,1.5l-6.7,6.5l-6.6-6.6L3.202,2.5z"></path></svg>
            </button>
        </div>
    )
}